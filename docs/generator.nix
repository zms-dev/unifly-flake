...
pkgs.runCommand "unifly-docs" { } ''
  ...
  sed -i -E "s|file:///nix/store/[a-z0-9]{32}-source/modules/home-manager.nix||g" $out/README.md
  sed -i -E "s|/nix/store/[a-z0-9]{32}-source/modules/home-manager.nix||g" $out/README.md
''
